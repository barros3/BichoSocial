package com.barros.shark74.bichosocial.util;
...
import com.barros.shark74.bichosocial.activity.MainActivity;
...
//        });
    ...
    public void novoUsuario(View view) {
        ...
        if (!name.isEmpty() && !email.isEmpty() && !password.isEmpty()) {
            ...
            Toast.makeText(getApplicationContext(), "Por favor preencha os campos!", Toast.LENGTH_LONG)
                    .show();
        }
    }
    ...
    private void registerUser(final String name, final String email, final String password) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        Toast.makeText(getApplicationContext(), "Cadastro realizado com sucesso, Faça o login agora!", Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                Log.e(TAG, "Erro ao se registrar: " + error.getMessage());
                Toast.makeText(getApplicationContext(),
